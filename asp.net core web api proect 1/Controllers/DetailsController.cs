...
namespace asp.net_core_web_api_proect_1.Controllers
{
        ...
        public class DetailsController : ControllerBase
    {
        ...
        ///<remarks>NOTE: for testing purpose of 'Retry and Backoff Mechanism' id=10000 and id=15000 is reserved (and intentionaly implemented for testing ). to check that mechanism type 10000 to id and look itno debug window. 10000 for success after few failure and 15000 for failure in every attempt </remarks>
